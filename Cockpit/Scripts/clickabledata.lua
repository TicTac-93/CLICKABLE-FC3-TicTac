...
elements["PNT_MODE_AG"]             = default_axis_limited("Master Modes Select",                           devices.CLICKABLE,  device_commands.CLIC_MODE)
elements["PNT_MODE_NAV"]            = default_button("Navigation Modes",                                    devices.CLICKABLE,  device_commands.CLIC_NAVMODES      )
elements["PNT_CM_CHAFF"]            = default_button("Countermeasures Chaff Dispense",                      devices.CLICKABLE,  device_commands.CLIC_CTM_CHAFF     )
elements["PNT_CM_FLARE"]            = default_button("Countermeasures Flares Dispense",                     devices.CLICKABLE,  device_commands.CLIC_CTM_FLARE     )
elements["PNT_CM_AUTO"]             = default_button("Countermeasures Continuously Dispense",               devices.CLICKABLE,  device_commands.CLIC_CTM           )
elements["PNT_RIP_INT_SET"]         = default_axis_limited("Ripple Interval Increase/Decrease",             devices.CLICKABLE,  device_commands.CLIC_RIPPLE_INT    )
elements["PNT_RIP_QTY_SET"]         = default_axis_limited("Ripple Quantity Increase",                      devices.CLICKABLE,  device_commands.CLIC_RIPPLE_QTA10  )
elements["PNT_RIP_MODE_SET"]        = default_axis_limited("PRS/SGL Release Submodes Cycle",                devices.CLICKABLE,  device_commands.CLIC_PRS_SGL       )
elements["PNT_WEP_CYC_1"]           = default_button("Weapon Change",                                       devices.CLICKABLE,  device_commands.CLIC_STATION       ) 
elements["PNT_WEP_CYC_2"]           = default_button("Weapon Change",                                       devices.CLICKABLE,  device_commands.CLIC_STATION       ) 
elements["PNT_FLAPS_SET"]           = default_button("Flaps Up/Down",                                       devices.CLICKABLE,  device_commands.CLIC_FLAPS_MULTI   )
elements["PNT_LGT_LAND"]            = default_button("Gear Light Near/Far/Off",                             devices.CLICKABLE,  device_commands.CLIC_LANDING_LIGHTS)
elements["PNT_MIRROR_U"]            = default_button("Toggle Mirrors",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_MIRROR_L"]            = default_button("Toggle Mirrors",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
elements["PNT_MIRROR_R"]            = default_button("Toggle Mirrors",                                      devices.CLICKABLE,  device_commands.CLIC_MIRROR        )
